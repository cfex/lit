...
lit can map query results to any registered struct, not just your main models. This enables DTOs (Data Transfer Objects) for partial selects, JOINs, and aggregations.
...
3. **Column validation**: lit validates columns at runtime and returns clear errors for mismatches
